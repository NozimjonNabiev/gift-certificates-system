...
class TagControllerTest {
    ...
    class FindAllTest {
        ...
        @Test
        public void shouldThrowNotFoundExceptionIfTagsWereNotFoundTest() throws NotFoundException {
        ...
        @Test
        public void shouldReturnResponseWithCorrectListIfNoExceptionWasThrownTest() throws NotFoundException {
    ...
    class FindByIdTest {
        ...
        @Test
        public void shouldThrowNotFoundExceptionIfTagWasNotFoundTest() throws NotFoundException {
            doThrow(NotFoundException.class)
                    .when(tagService)
                    .findById(0L);
        ...
        @Test
        public void shouldReturnResponseWithCorrectTagIfNoExceptionWasThrownTest() throws NotFoundException {
    ...
    class CreateTest {
        ...
        @Test
        public void shouldThrowModificationExceptionIfExceptionWasThrownTest() throws DataModificationException {
            when(bindingResult.hasErrors())
                    .thenReturn(false);
    ...
    class DeleteTest {
        ...
        @Test
        public void shouldThrowNotFoundExceptionIfTagWasNotFoundTest() throws NotFoundException, DataModificationException {
            doThrow(NotFoundException.class)
                    .when(tagService)
                    .delete(0L);
            assertThrows(NotFoundException.class,
        ...
        @Test
        public void shouldThrowModificationExceptionIfExceptionWasThrownTest() throws NotFoundException, DataModificationException {
            doThrow(NotFoundException.class)
                    .when(tagService)
                    .delete(0L);
            assertThrows(NotFoundException.class,
        ...
        @Test
        public void shouldReturnResponseWithCorrectStatusIfNoExceptionWasThrownTest() throws NotFoundException, DataModificationException {
            doNothing()
                    .when(tagService)
                    .delete(0L);
            assertEquals(HttpStatus.OK,
