...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Handles {@link AccessDeniedException} by returning a custom error message with
     * appropriate status and HATEOAS links.
     *
     * @param ex      The exception instance.
     * @return A ResponseEntity containing the error message and links.
    ...
    public ResponseEntity<MessageHolder> handleAccessDeniedException(AccessDeniedException ex) {
    ...
    /**
     * Handles {@link AuthenticationException} by returning a custom error message with
     * appropriate status and HATEOAS links.
     *
     * @param ex      The exception instance.
     * @return A ResponseEntity containing the error message and links.
    ...
    public ResponseEntity<MessageHolder> handleAuthenticationException(AuthenticationException ex) {
